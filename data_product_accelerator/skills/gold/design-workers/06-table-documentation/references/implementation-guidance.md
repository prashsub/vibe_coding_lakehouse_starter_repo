...
- [YAML-Driven Gold Setup](../../pipeline-workers/01-yaml-table-setup/SKILL.md) - Patterns for creating Gold tables from YAML
- [Gold Layer Merge Patterns](../../pipeline-workers/02-merge-patterns/SKILL.md) - MERGE operation patterns
- [Merge Schema Validation](../../pipeline-workers/05-schema-validation/SKILL.md) - Pre-merge validation patterns
