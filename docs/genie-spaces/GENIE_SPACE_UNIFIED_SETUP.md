...
|------------------|-----------|--------|--------------|
| `revenue_analytics_metrics` | `${catalog}.${gold_schema}.revenue_analytics_metrics` | 💰 Revenue | total_revenue, booking_count, avg_booking_value, cancellation_rate, payment_rate |
| `engagement_analytics_metrics` | `${catalog}.${gold_schema}.engagement_analytics_metrics` | 📊 Marketing | total_views, total_clicks, avg_conversion_rate, click_through_rate |
| `property_analytics_metrics` | `${catalog}.${gold_schema}.property_analytics_metrics` | 🏠 Property | property_count, avg_base_price, revenue_per_property, total_capacity |
| `host_analytics_metrics` | `${catalog}.${gold_schema}.host_analytics_metrics` | 👤 Host | host_count, avg_rating, verification_rate, revenue_per_host |
| `customer_analytics_metrics` | `${catalog}.${gold_schema}.customer_analytics_metrics` | 🎯 Customer | customer_count, spend_per_customer, bookings_per_customer, total_spend |
...
|------------|-----------|---------|-------------|
| `dim_property` | `${catalog}.${gold_schema}.dim_property` | Property listings | property_id, title, property_type, base_price, bedrooms, host_id |
| `dim_destination` | `${catalog}.${gold_schema}.dim_destination` | Geographic locations | destination_id, destination, country, state_or_province |
| `dim_host` | `${catalog}.${gold_schema}.dim_host` | Host information | host_id, name, is_verified, rating, country |
...
|----------|-----------|---------|
| `get_revenue_by_period` | `${catalog}.${gold_schema}.get_revenue_by_period(start_date, end_date, time_grain)` | Revenue trends by day/week/month/quarter |
| `get_top_properties_by_revenue` | `${catalog}.${gold_schema}.get_top_properties_by_revenue(start_date, end_date, top_n)` | Top N properties by revenue |
| `get_revenue_by_destination` | `${catalog}.${gold_schema}.get_revenue_by_destination(start_date, end_date, top_n)` | Revenue by geography |
| `get_payment_metrics` | `${catalog}.${gold_schema}.get_payment_metrics(start_date, end_date)` | Payment method performance |
| `get_cancellation_analysis` | `${catalog}.${gold_schema}.get_cancellation_analysis(start_date, end_date)` | Cancellation rates and lost revenue |
| `get_revenue_forecast_inputs` | `${catalog}.${gold_schema}.get_revenue_forecast_inputs(start_date, end_date, property_id)` | ML forecasting data |

### 📊 Engagement TVFs (5)

| Function | Full Path | Purpose |
|----------|-----------|---------|
| `get_property_engagement` | `${catalog}.${gold_schema}.get_property_engagement(start_date, end_date, property_id)` | Property engagement metrics |
| `get_conversion_funnel` | `${catalog}.${gold_schema}.get_conversion_funnel(start_date, end_date, destination)` | View→Click→Book funnel |
| `get_traffic_source_analysis` | `${catalog}.${gold_schema}.get_traffic_source_analysis(start_date, end_date)` | Traffic by property type |
| `get_engagement_trends` | `${catalog}.${gold_schema}.get_engagement_trends(start_date, end_date, time_grain)` | Daily/weekly engagement |
| `get_top_engaging_properties` | `${catalog}.${gold_schema}.get_top_engaging_properties(start_date, end_date, top_n)` | Top properties by engagement |

### 🏠 Property TVFs (5)

| Function | Full Path | Purpose |
|----------|-----------|---------|
| `get_property_performance` | `${catalog}.${gold_schema}.get_property_performance(start_date, end_date, destination)` | Property KPIs |
| `get_availability_by_destination` | `${catalog}.${gold_schema}.get_availability_by_destination(start_date, end_date, top_n)` | Inventory by market |
| `get_property_type_analysis` | `${catalog}.${gold_schema}.get_property_type_analysis(start_date, end_date)` | Performance by type |
| `get_amenity_impact` | `${catalog}.${gold_schema}.get_amenity_impact(start_date, end_date)` | Amenity correlation |
| `get_pricing_analysis` | `${catalog}.${gold_schema}.get_pricing_analysis(start_date, end_date)` | Price point performance |

### 👤 Host TVFs (5)

| Function | Full Path | Purpose |
|----------|-----------|---------|
| `get_host_performance` | `${catalog}.${gold_schema}.get_host_performance(start_date, end_date, host_id)` | Host KPIs |
| `get_host_quality_metrics` | `${catalog}.${gold_schema}.get_host_quality_metrics(start_date, end_date, top_n)` | Top hosts by quality |
| `get_host_retention_analysis` | `${catalog}.${gold_schema}.get_host_retention_analysis(start_date, end_date)` | Active vs churned |
| `get_host_geographic_distribution` | `${catalog}.${gold_schema}.get_host_geographic_distribution(start_date, end_date, top_n)` | Hosts by country |
| `get_multi_property_hosts` | `${catalog}.${gold_schema}.get_multi_property_hosts(start_date, end_date, min_properties)` | Professional hosts |

### 🎯 Customer TVFs (5)

| Function | Full Path | Purpose |
|----------|-----------|---------|
| `get_customer_segments` | `${catalog}.${gold_schema}.get_customer_segments(start_date, end_date)` | Segment distribution |
| `get_customer_ltv` | `${catalog}.${gold_schema}.get_customer_ltv(start_date, end_date, top_n)` | Top customers by LTV |
| `get_booking_frequency_analysis` | `${catalog}.${gold_schema}.get_booking_frequency_analysis(start_date, end_date)` | Frequency distribution |
| `get_customer_geographic_analysis` | `${catalog}.${gold_schema}.get_customer_geographic_analysis(start_date, end_date, top_n)` | Customers by country |
| `get_business_vs_leisure_analysis` | `${catalog}.${gold_schema}.get_business_vs_leisure_analysis(start_date, end_date)` | B2B vs B2C comparison |

### 🤖 ML Prediction TVFs (7)

| Function | Full Path | Purpose |
|----------|-----------|---------|
| `get_demand_predictions` | `${catalog}.${gold_schema}.get_demand_predictions(destination_id, min_predicted_bookings)` | Query demand forecasts |
| `get_conversion_predictions` | `${catalog}.${gold_schema}.get_conversion_predictions(min_probability, property_id)` | Query conversion probabilities |
| `get_pricing_recommendations` | `${catalog}.${gold_schema}.get_pricing_recommendations(month, is_peak_season)` | Seasonal pricing aggregates |
| `get_pricing_by_destination` | `${catalog}.${gold_schema}.get_pricing_by_destination('Miami')` | **Pricing for destination properties** |
| `get_customer_ltv_predictions` | `${catalog}.${gold_schema}.get_customer_ltv_predictions(ltv_segment, min_ltv, user_id)` | Query customer LTV predictions |
| `get_vip_customers` | `${catalog}.${gold_schema}.get_vip_customers()` | Quick access to VIP customers (LTV > $2500) |
| `get_high_demand_properties` | `${catalog}.${gold_schema}.get_high_demand_properties(top_n)` | Top properties by predicted demand |
| `get_ml_predictions_summary` | `${catalog}.${gold_schema}.get_ml_predictions_summary()` | Summary of all ML models and prediction counts |
...
```sql
SELECT *
FROM ${catalog}.${gold_schema}.get_vip_customer_property_preferences();
```
...
```sql
SELECT *
FROM ${catalog}.${gold_schema}.get_pricing_by_destination('Miami');
```
...
**Expected SQL:**
```sql
SELECT * FROM ${catalog}.${gold_schema}.get_vip_customers();
```
...
**Expected SQL:**
```sql
SELECT * FROM ${catalog}.${gold_schema}.get_ml_predictions_summary();
```
...
2. Add ALL 5 Metric Views (primary data sources):
   - ${catalog}.${gold_schema}.revenue_analytics_metrics
   - ${catalog}.${gold_schema}.engagement_analytics_metrics
   - ${catalog}.${gold_schema}.property_analytics_metrics
   - ${catalog}.${gold_schema}.host_analytics_metrics
   - ${catalog}.${gold_schema}.customer_analytics_metrics

3. Add ALL 26 Analytics TVFs (grouped by domain)

4. Add ALL 7 ML Prediction TVFs:
   - ${catalog}.${gold_schema}.get_demand_predictions
   - ${catalog}.${gold_schema}.get_conversion_predictions
   - ${catalog}.${gold_schema}.get_pricing_recommendations
   - ${catalog}.${gold_schema}.get_customer_ltv_predictions
   - ${catalog}.${gold_schema}.get_vip_customers
   - ${catalog}.${gold_schema}.get_high_demand_properties
   - ${catalog}.${gold_schema}.get_ml_predictions_summary

5. Add Dimension Tables:
   - ${catalog}.${gold_schema}.dim_property
   - ${catalog}.${gold_schema}.dim_destination
