...
1. `.cursor/skills/monitoring/04-anomaly-detection/SKILL.md` — Schema-level freshness/completeness monitoring
...
- **`planning/00-project-plan-methodology`** — Plan the semantic layer, observability, ML, and GenAI agent phases
