...
mkdir -p ".cursor/skills/admin/${SKILL_NAME}"
```
...
Place skills under `.cursor/skills/{domain}/`:
...
- For converting existing Cursor rules to skills, see the `cursor-rule-to-skill` skill
