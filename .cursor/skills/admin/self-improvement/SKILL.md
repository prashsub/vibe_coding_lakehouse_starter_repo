...
find .cursor/skills -name "SKILL.md" -exec dirname {} \; | xargs -I {} basename {}

# Step 2b: Search skill descriptions for related terms
grep -ri "keyword1\|keyword2\|keyword3" .cursor/skills/*/SKILL.md

# Step 2c: Read potentially related skills in full
cat .cursor/skills/{potential-match}/SKILL.md
```
...
1. **Scan relevant skills** in `.cursor/skills/`
...
2. SEARCH EXISTING SKILLS (mandatory before any skill changes):
   - [ ] Listed all skills: find .cursor/skills -name "SKILL.md"
...
cat > ".cursor/skills/${SKILL_NAME}/SKILL.md" << 'EOF'
---
...
EOF
echo "Created: .cursor/skills/${SKILL_NAME}/SKILL.md"
```
...
grep -l "import" .cursor/skills/*/SKILL.md 2>/dev/null
```
