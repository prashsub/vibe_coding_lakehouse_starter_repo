...
# Silver Layer Creation - Orchestrator Skill
...
| Only need DLT expectations patterns? | Read `silver/dlt-expectations-patterns/SKILL.md` directly |
| Need advanced DQX validation? | Read `silver/dqx-patterns/SKILL.md` directly |
...
|-------|-------------|------------------|
| `silver/dlt-expectations-patterns` | **MUST read** | DQ rules table DDL, rules loader cache pattern, DLT decorators, quarantine generation, runtime rule updates |
| `silver/dqx-patterns` | **Optional** | Read only when user needs richer diagnostics than DLT expectations, or pre-merge validation |
...
**Pre-Condition - MUST read these skills first:**
1. Read `silver/dlt-expectations-patterns/SKILL.md` - Use for DQ rules table DDL and population
...
2. Read `silver/dlt-expectations-patterns/SKILL.md` - Use cache pattern with `toPandas()`
...
2. Read `silver/dlt-expectations-patterns/SKILL.md` - Use decorator patterns
3. (Optional) Read `silver/dqx-patterns/SKILL.md` - Only if user needs hybrid DQX+DLT
...
|-------|-------------|------|
| `dlt-expectations-patterns` | **Mandatory** - DQ rules, loader, decorators | `silver/dlt-expectations-patterns/SKILL.md` |
| `dqx-patterns` | **Optional** - Advanced validation | `silver/dqx-patterns/SKILL.md` |
