...
|---|------------|------------------|
| 1 | `.cursor/skills/common/databricks-expert-agent/SKILL.md` | Extract-don't-generate principle |
| 2 | `.cursor/skills/semantic-layer/01-metric-views-patterns/SKILL.md` | YAML syntax, validation, joins |
...
| # | Skill Path | What It Provides |
|---|------------|------------------|
| 1 | `.cursor/skills/semantic-layer/02-databricks-table-valued-functions/SKILL.md` | STRING params, null safety, Genie compat |
...
| # | Skill Path | What It Provides |
|---|------------|------------------|
| 1 | `.cursor/skills/semantic-layer/03-genie-space-patterns/SKILL.md` | 7-section deliverable, agent instructions |
...
| # | Skill Path | What It Provides |
|---|------------|------------------|
| 1 | `.cursor/skills/semantic-layer/04-genie-space-export-import-api/SKILL.md` | REST API, JSON schema, CI/CD |
...
| # | Skill Path | What It Provides |
|---|------------|------------------|
| 1 | `.cursor/skills/semantic-layer/05-genie-space-optimization/SKILL.md` | Benchmark testing, 6 control levers |
