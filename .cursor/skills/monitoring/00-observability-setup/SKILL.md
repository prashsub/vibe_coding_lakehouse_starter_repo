...
| 2 | `.cursor/skills/monitoring/01-lakehouse-monitoring-comprehensive/SKILL.md` | Monitor setup, custom metrics |
...
| # | Skill Path | What It Provides |
|---|------------|------------------|
| 1 | `.cursor/skills/monitoring/02-databricks-aibi-dashboards/SKILL.md` | Dashboard JSON, widget patterns |
...
| # | Skill Path | What It Provides |
|---|------------|------------------|
| 1 | `.cursor/skills/monitoring/03-sql-alerting-patterns/SKILL.md` | Config-driven alerts, SDK deployment |
| 2 | `.cursor/skills/common/databricks-asset-bundles/SKILL.md` | Job YAML for alert deployment |
